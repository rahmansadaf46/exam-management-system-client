...
const UpdateQuestion = () => {
        ...
        fetch('http://localhost:5000/studentsForExam', {
            ...
            .then(data => {
                ...
                studentData.forEach(student=>{
                    updateData.push({...student, obtainedMark: 0, fullMark: 10,answer:[]})
                })
    ...
    let addFormFieldsFillInTheBlanks = () => {
        ...
        setQuestionQuantity(parseInt(questionQuantity) + 1)
    }
    ...
    console.log(assignmentData, mcqQuestion, id);
    return (
        <>
            {
                isTeacher === true ?
                    <div>
                        ...
                        <div className="d-flex">
                            ...
                            <div style={{ backgroundColor: '#F4F7FC', minHeight: '87vh', height: 'auto', width: '100%' }} className=" pt-4">
                                <div className=" ">
                                    <div className="semester-header"><h2>Update Question</h2></div>
                                    {
